...
cd ../../../data/metabolon/step4/alspac/metaboprep_output/

# need to add in a column header for the sample ID column
# extract header
head -n 1 2026_01_31_MetaboliteData.txt > ../data_return/temp_header_line.txt
# extract all but header
tail -n +2 2026_01_31_MetaboliteData.txt > ../data_return/temp_metab_data.txt
